//<script type="text/javascript">
	$(function() {
		...
		$.ajax({
			type : "GET",
			url : "/app/appserver/getContractInfoFromACQ",
			data : {
				"applseq" : applseq
			},
			dataType : "json",
...
//				$("span [name=date]").text(data.body.date);
	            $("#merchName").text(data.body.merchName);
				$("#expressTnr").text(data.body.applyTnr);
//				$("#monthRepay").text(data.body.monthRepay);
				$("#contractNo").text(data.body.contractNo);
				$("#custName").text(data.body.custName);
				$("#identifyNo").text(data.body.identifyNo);
				$("#custAddress").text(data.body.custAddress);
