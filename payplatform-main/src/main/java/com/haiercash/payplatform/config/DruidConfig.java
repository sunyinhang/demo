...
/**
 * Created by lihua on 2016/11/21.
 */
@Configuration
public class DruidConfig {
    @Value("${datasources.portal.druid.path:}")
    private String path;
    @Value("${datasources.portal.druid.loginUsername:}")
    private String loginUsername;
    @Value("${datasources.portal.druid.loginPassword:}")
