...
//                        SgtsLog sgtsLog = new SgtsLog();
                        ...
                        if ("43".equals(msgTyp)) {//额度申请被拒    25
                            ...
                            result = RestTemplateUtils.postForString(url_ts + "/paycenter/json/ious/limitNotify.json", encrypt);
                            ...
                            result = RestTemplateUtils.postForString(url_ts + "/paycenter/json/ious/notify.json", encrypt);
