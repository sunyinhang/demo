...
//        applSeq = relation.getApplSeq();
        ...
        hashMapOne.put("idNo", com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(certNo));
        hashMapOne.put("name", com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(custName));
        hashMapOne.put("mobile", com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(mobile));
        ...
        listTwo.add(com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(area));
        hashMapTwo.put("idNo", com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(certNo));
        hashMapTwo.put("name", com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(custName));
        hashMapTwo.put("mobile", com.haiercash.mybatis.util.EncryptUtil.simpleEncrypt(mobile));
