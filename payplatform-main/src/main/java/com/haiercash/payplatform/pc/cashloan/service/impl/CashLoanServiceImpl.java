...
public class CashLoanServiceImpl extends BaseService implements CashLoanService {
    ...
    @Autowired
    private ActivityPageSettingDao activityPageSettingDao;

    @Override
    public Map<String, Object> getActivityUrl() {
        String channelNo = this.getChannelNo();
        this.logger.info("开始活动跳转 channelNo:" + channelNo);
        ActivityPageSetting setting = this.activityPageSettingDao.selectByPrimaryKey(channelNo);
    ...
    private Map<String, Object> joinActivityRedirect(Map<String, Object> params, ActivityPageSetting setting) {
