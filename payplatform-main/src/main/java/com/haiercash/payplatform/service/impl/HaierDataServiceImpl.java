...
import com.haiercash.payplatform.config.HaierGroupConfig;
...
public class HaierDataServiceImpl implements HaierDataService {
    ...
    @Autowired
    private HaierGroupConfig haierGroupConfig;

    @Override
    public String userinfo(String token) {
        String url = haierGroupConfig.getAccountUrl() + "/userinfo?access_token=" + token;
