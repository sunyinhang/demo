...
public class GlobalData {
    ...
    public static final int T_SET_HEADIMG = 0x0002;//设置是否要截取人头像信息
	public static int T_SET_LOGPATH   = 0x0004;// 设置保存g保存文件位置
	public static int T_SET_OPENORCLOSE_LOGPATH = 0x0005;// 打开关闭保存log文件功能
    public static final int T_SET_HEADIMGBUFMODE = 0x0006;// 设置人头像模式 0= 原始形式(便于android ios直接加载)   1=BASE64加密形式(便于sdk网络传输)
    ...
    public static final int TIDCARD2 = 0x11;   /*二代证*/
