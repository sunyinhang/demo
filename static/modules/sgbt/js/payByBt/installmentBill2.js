var page=1; //页数
var size=3; //条数
var url='QueryPendingLoanInfoServlet.do';
    			    		...
    			    		if(util.isEmpty(obj.retObj)){
    			    			$('#pullUp').html('已经是全部数据了，没有待加载的数据了。。。。');
        		       			...
        		       			for(var i=0;i<sizeTemp;i++){
        		        		    ...
        		        		    if(obj.retObj[i].outSts=="待提交"){btnTextHtml='<a href="javascript:void(0)" onclick="delOrder(\''+obj.retObj[i].orderNo+'\',this)" class="button payBlueBtn">取消订单</a><a href="javascript:void(0)" class="button payBlueBtn" id="resubmit" data-orderNo="'+obj.retObj[i].orderNo+'">继续提交</a>';}
