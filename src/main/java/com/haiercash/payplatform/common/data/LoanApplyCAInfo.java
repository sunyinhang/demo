 ...
 * -----------------------------------------------------------------------------
 * V1.00     2016年2月28日   Haiercash    xuchao      CREATE
 * -----------------------------------------------------------------------------
 *
 *
 ...
 *
 * <p>
 * <a href="LoanApplyCAInfo.java"><i>View Source</i></a>
 * </p>
 * 
 * @author <a href="mailto:xuchao@haiercash.com">xuchao</a>
 *
 * @version Revision: 1.0  Date: 2016年2月28日 下午8:27:19 
 *
 */

public class LoanApplyCAInfo {
	private String id;
	...
	public String getUserloanamt() {
		return userloanamt;
	}
	public void setUserloanamt(String userloanamt) {
		this.userloanamt = userloanamt;
	}
