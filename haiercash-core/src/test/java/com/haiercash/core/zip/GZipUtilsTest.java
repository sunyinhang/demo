...
public class GZipUtilsTest {
    private static final String DEMO = "I am happy to join with you today in what will go down in history as the greatest demonstration for freedom in the history of our nation.\n" +
    ...
    //注意:压缩后,字节流一般会变小,但由于还要 base64 编码,内容较少时 string 层面会变长
    @Test
